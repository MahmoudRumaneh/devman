...
function isPrivateIp(address) {
  ...
  return normalized === '::' || normalized === '::1' || normalized.startsWith('fc') ||
    ...
    normalized.startsWith('64:ff9b:') || normalized.startsWith('2001:0000:') ||
...
function validateLocalProxyUrl(rawUrl) {
...
module.exports = { validateLocalProxyUrl, validateProxyUrl };
